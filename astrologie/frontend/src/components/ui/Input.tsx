...
export function Input({ bezeichnung, fehler, hinweis, className, id, ...rest }: InputProps) {
    ...
    <div className="flex flex-col gap-1">
      ...
      <input
        ...
        className={cn(
          ...
          'placeholder:text-text3 transition-shadow duration-150',
        ...
        aria-describedby={fehler ? `${eingabeId}-fehler` : hinweis ? `${eingabeId}-hinweis` : undefined}
        {...rest}
      />
